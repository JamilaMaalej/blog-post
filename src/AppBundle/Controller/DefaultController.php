...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('AppBundle:default:concert.html.twig', array('concert' => $concert));
    }
     ...
     */
     ...
     public function concertssAction()
    {
        $concerts = $this->getDoctrine()->getRepository('AppBundle:Concert')->findAll();

        return $this->render('AppBundle:default:concerts.html.twig', array('concerts' => $concerts));
    }
}
